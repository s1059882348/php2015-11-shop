...
<div style="clear:both;"></div>
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="breadcrumb">
			<h2>当前位置：<a href="">首页</a>  >
				<?php if(is_array($goodsCategorys)): $i = 0; $__LIST__ = $goodsCategorys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goodsCategory): $mod = ($i % 2 );++$i;?><a href=""><?php echo ($goodsCategory["name"]); ?></a>&nbsp; >  &nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
				<?php echo ($name); ?></h2>
		</div>
		<!-- 面包屑导航 end -->
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="http://admin.shop.com/Uploads/<?php echo ($gallerys[0]); ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="http://admin.shop.com/Uploads/<?php echo ($gallerys[0]); ?>!big" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<?php if(is_array($gallerys)): $i = 0; $__LIST__ = $gallerys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$gallery): $mod = ($i % 2 );++$i;?><li <?php if(($i) == "1"): ?>class="cur"<?php endif; ?>  >
									<a <?php if(($i) == "1"): ?>class="zoomThumbActive"<?php endif; ?> href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://admin.shop.com/Uploads/<?php echo ($gallery); ?>!big',largeimage: 'http://admin.shop.com/Uploads/<?php echo ($gallery); ?>'}"><img src="http://admin.shop.com/Uploads/<?php echo ($gallery); ?>!small"></a>
